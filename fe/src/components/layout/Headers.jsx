...
const heroSlides = [
  {
    ...
    subtitle:
      "Mang đến vẻ đẹp rạng ngời và sự tự tin qua dịch vụ trang điểm chuyên nghiệp.",
  },
  {
    id: 2,
    ...
    subtitle:
      "Makeup Artist dày dạn kinh nghiệm, sẵn sàng biến hoá bạn trong mọi dịp quan trọng.",
  },
  {
    id: 3,
    ...
    subtitle:
      "Dịch vụ makeup chuyên nghiệp cho mọi sự kiện, giúp bạn luôn tỏa sáng ở bất cứ nơi đâu.",
  },
];
        ...
        >
          ...
          >
            <Box textAlign="center">
              <TypeAnimation
                sequence={["Kết nối makeup artist", 2000, "Makeup hub", 1500]}
                wrapper="span"
                cursor={true}
                repeat={Infinity}
                style={{
